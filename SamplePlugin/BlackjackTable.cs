...
internal sealed class BlackjackTable
{
    ...
    public void OpenTableAndDeal()
    {
        ...
        LastPublicMessage = "Table open! Type !bj join. Then !bj bet <amt>. Leader will /bj deal when ready.";
        DealNextRound();
    }
    ...
    {
        ImGui.SetClipboardText(LastPublicMessage);
    }

    public void CopyPublicMessageAsPartyCommandToClipboard()
    {
        ImGui.SetClipboardText($"/p {LastPublicMessage}");
    }
